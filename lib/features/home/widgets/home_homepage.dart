...
>>>>>>> 5ee24125197ad5cf24fba61a909209004fa091e4
        ...
        SliverToBoxAdapter(
          child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Text('Curated Disciplines',
        ...
        child: Row(children: [
          ...
          Container(
            ...
            child: const Icon(Icons.tune_rounded,
                color: Color(0xFF4A321B), size: 18),
          ),
        ]),
      ),
    );
...
<<<<<<< HEAD
                  ...
                  SizedBox(
                    ...
                    child: FilledButton(
                      ...
                      child: const Text('Quick Add to Cart',
                        style:
